...
to .fbx format.  There are command-line options to fine-tune the fbx
creation.  The defaults are:
...
sys.path.append("/home/deploy/Support")
...
try:
  ...
  sys.path.append("/home/deploy/fbx/lib/Python27_ucs4_%s" % arch)
  from fbx import *
except ImportError:
...
def main():
  import argparse
  parser = argparse.ArgumentParser(description="Sample script to convert raw Tilt Brush geometry .fbx format.")
